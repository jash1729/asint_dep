sap.ui.define([
    ...
    return Utility.extend("com.asint.ais.library.datasource.asint.Replicator", {
        URL: URL,
        ...
        fnCreateTask: function (oPayload, fnSuccess, fnError) {
            var sUrl = this._baseURI + this.URL["createTaskReplicator"];
		 ...
		 * @param {function} fnError 
		 */
        getStatusCountReplicatorlist:function(fnSuccess,fnError)
        { 
		 ...
		 * @param {function} fnError 
		 */
        getReplicatorHeaderDetails:function(sId, fnSuccess,fnError) {
		 ...
		 * @param {function} fnError 
		 */
        getReplicatorTasklogs:function(sId, fnSuccess,fnError) {
		 ...
		 * @param {function} fnError 
		 */
        getSelectedObjectTypeData:function(sObjectId, sObjectType, fnSuccess,fnError) {
            var sUrl = this._baseURI + this.URL["getObjectData"];
            var oParam = {
                ID: sObjectId,
                type: sObjectType
            };
		 ...
		 * @param {function} fnError 
		 */
        updaeteReplicatorHeaderDetails:function(sId,oPayload,fnSuccess,fnError, etag) {
            var sUrl = this._baseURI + this.URL["getReplicatoDetails"];
            var oParam = {
                ID: sId
            }
        ...
        getObjectTypesEnum:function(fnSuccess,fnError) {
            var sUrl = this._baseURI + this.URL["getObjectTypes_Replicator"];
