sap.ui.define([
    ...
    return Control.extend("com.asint.ais.library.control.RiskYAxis", {
        metadata: {
            properties: {
            ...
            aggregations: {
                axisValues: { type: "com.asint.ais.library.control.RiskAxisValues", multiple: true, singularName: "axisValue" }
            },
